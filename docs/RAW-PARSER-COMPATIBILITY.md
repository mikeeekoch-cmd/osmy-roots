# Preserved raw-format parser reference

This documents the optional ingestDemoPacket raw-schema API, not the live runtime parser. Its paragraph captions and dated chat assumptions do not support the canonical frozen packet. Use PARSER-COMPATIBILITY.md for the app.
